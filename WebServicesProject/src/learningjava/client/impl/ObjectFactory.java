 ...
 * generated in the learningjava.client.impl package. 
...
public class ObjectFactory {
    ...
    private final static QName _EchoString_QNAME = new QName("http://webservices/", "echoString");
    private final static QName _EchoIntResponse_QNAME = new QName("http://webservices/", "echoIntResponse");
    private final static QName _EchoMyObject_QNAME = new QName("http://webservices/", "echoMyObject");
    private final static QName _EchoMyObjectResponse_QNAME = new QName("http://webservices/", "echoMyObjectResponse");
    private final static QName _EchoStringResponse_QNAME = new QName("http://webservices/", "echoStringResponse");
    private final static QName _EchoInt_QNAME = new QName("http://webservices/", "echoInt");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: learningjava.client.impl
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "echoString")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "echoIntResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "echoMyObject")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "echoMyObjectResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "echoStringResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "echoInt")
